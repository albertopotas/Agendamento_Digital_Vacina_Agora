...
// campos formulario   
 ...
 $sql="SELECT * from `cadagenda`
 (`cpf`, `nome`, `datanasc`, `email`, `endereco`, `numero`, `apto`, `bairro`, `cidade`, `datadisp`) VALUES 
 (`$cpf`, `$nome`, `$datanasc`, `$email`, `$endereco`, `$numero`, `$apto`, `$bairro`, `$cidade`, `$datadisp`)";
