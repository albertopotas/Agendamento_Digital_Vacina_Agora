...
<head>
	...
	<title>Area: Administrador - Consulta de Vacinas / Agendamento</title>
</head>
...
<body>
   ...
   ?>
	...
	<div class="tituloInformacoes ">Consulta de Agendamentos</div>
		...
		<div class="content">
			<main>
				<form id="formConsultagenda" name="" method="POST" action="">
					...
					<input type="date" nome="data" autofocus>
